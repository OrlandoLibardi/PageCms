  ...
  $.fn.OLFiles = function(options, callback) {
    ...
    function initListFolders(directories) {
        ...
        $.each(directories, function(a, b) {
          ...
          obj += '<button class="btn btn-xs btn-danger btn-flat folder-delete" data-url="' + b.url + '"><i class="fa fa-trash"></i></button>';
          obj += '<button class="btn btn-xs btn-warning btn-flat folder-rename" data-url="' + b.url + '"><i class="fa fa-file-o"></i></button>';
          obj += '<div class="file">';
    ...
    function initListFiles(files) {
      ...
      $.each(files, function(a, b) {
        obj += '<div class="file-box">';
        obj += '<button class="btn btn-xs btn-danger btn-flat file-delete" data-url="' + b.url + '"><i class="fa fa-trash"></i></button>';
        obj += '<button class="btn btn-xs btn-info btn-flat file-edit" data-url="' + b.url + '"><i class="fa fa-pencil"></i></button>';
        obj += '<div class="file">';
