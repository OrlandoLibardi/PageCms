                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('name', $page->name, ['placeholder' => 'Título da página...','class' =>
                            'form-control']) !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('meta_title', $page->meta_title, ['placeholder' => 'Meta Title...','class' =>
                            'form-control']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('meta_description', $page->meta_description, ['placeholder' => 'Meta Description...','class'
                            => 'form-control']) !!}
                        </div>
                    </div>
                </div>
